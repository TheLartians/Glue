...
namespace glue {
  ...
  struct ElementInterface {
    ...
    template <class T, typename = typename std::enable_if<!std::is_base_of<
                           ElementInterface, typename std::decay<T>::type>::value>::type>
    ...
    template <typename... Args> Any operator()(Args &&... args) const {
      return getValue().get<AnyFunction>()(
          element_detail::convertArgument<Args>(std::forward<Args>(args))...);
    }
  ...
  public:
    ...
    template <class T,
              typename = typename std::enable_if<
                  ...
                  && !std::is_base_of<ElementInterface, typename std::decay<T>::type>::value>::type>
